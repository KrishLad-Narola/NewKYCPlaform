...
export const trustBreakdown = [
  { factor: "KYC Authenticity", weight: 40, score: 38, max: 40 },
  { factor: "Legal Compliance", weight: 30, score: 28, max: 30 },
  { factor: "Transaction History", weight: 30, score: 19, max: 30 },
];
