...
export default function AdminAudit() {
  return (
    <>
      <PageHeader kicker="System" title="Platform Audit Logs" description="Network-wide immutable activity ledger." />
          ...
          <tbody>
            {auditLogs.map((l) => (
              <tr key={l.id} className="border-t border-slate-900/[0.06] hover:bg-slate-900/[0.03]">
                ...
                <td className="px-5 py-3"><span className="text-[11px] font-mono uppercase px-2 py-1 rounded-full bg-primary/15 text-cyan-glow">{l.type}</span></td>
