...
export default function AdminBusinesses() {
  ...
  return (
    <>
      <PageHeader kicker="Roster" title="Businesses" description="Search, audit, and manage every business across the network." />
              ...
              <tr key={b.id} className="border-t border-slate-900/[0.06] hover:bg-slate-900/[0.03]">
                <td className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-primary to-cyan-glow grid place-items-center text-xs font-semibold">{b.logo}</div>
                    <div>
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center justify-end gap-1">
                    <button onClick={() => toast.success("Score override saved")} title="Override score" className="h-8 w-8 grid place-items-center rounded-lg hover:bg-slate-900/[0.03] text-muted-foreground hover:text-cyan-glow"><Edit3 className="h-4 w-4" /></button>
